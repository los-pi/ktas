...
import Input from "components/_shared/input-field";
...
const LoginForm: FC<ILoginForm> = ({ onSubmit }) => {
	const { user, password, handleChange, handleSubmit, loading } = useLoginForm(onSubmit);
		...
		<div className="form-container">
			...
			<form className="login-form" autoComplete="off" onSubmit={handleSubmit}>
				...
				<button type="submit" className="login-form__action--submit">
					{loading && <Loader data-testid="loading-icon" />}
					{!loading && "ingresar"}
				</button>
			</form>
